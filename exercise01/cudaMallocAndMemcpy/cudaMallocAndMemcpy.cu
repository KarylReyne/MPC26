...
int main(int argc, char** argv)
{
    ...
    cudaMalloc(&d_a, dimA*sizeof(float));
    cudaMalloc(&d_b, dimA*sizeof(float));
    ...
    cudaMemcpy(d_b, d_a, dimA * sizeof(float), cudaMemcpyDeviceToDevice);
    ...
    cudaMemcpy(h_a, d_b, dimA * sizeof(float), cudaMemcpyDeviceToHost);
